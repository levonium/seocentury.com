---
title: "Rel-Alternate-Hreflang Annotations: Common Issues To Pay Attention To"
pubDate: "2015-05-03T19:33:14"
slug: "rel-alternate-hreflang-annotations-common-issues-to-pay-attention-to"
---
...
Using _rel=”alternate” hreflang=”x”_ annotations is very useful, however you need to set up them properly. Here are some common issues with hreflang annotations that I have noticed.
...
_It is easy to avoid such issues just by double checking the language and region codes in Wikipedia._
...
_If you made this to affect your sites organic visibility in separate countries, you better don’t. Because it will not help and you will end up having a bunch of errors in your webmaster tools international targeting report._
...
_You can check your webmaster tools international targeting report for such errors and correct them to avoid your link=”alternate” hreflang=”x” tags being ignored._
...
_Bing does not support the hreflang annotations. Instead, it uses [language meta tags](https://blogs.bing.com/webmaster/2011/03/01/how-to-tell-bing-your-websites-country-and-language/), for example:_
